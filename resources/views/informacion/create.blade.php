                ...
                <form action="{{ url('informacion') }}" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="fecha" id="fecha" placeholder="" required>
                            <!--div class="invalid-feedback">
                        ...
                        <div class="col-md-8 mb-3">
                            ...
                            <textarea class="form-control" name="info" id="info" rows="2" placeholder=""></textarea>
                            <!--div- class="invalid-feedback">
                        ...
                        <hr class="col-md-12 mb-4">
                        <button class="col-4 btn btn-danger" type="submit">Insertar</button>
                    </div>
