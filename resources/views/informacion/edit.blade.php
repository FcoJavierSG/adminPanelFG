                ...
                <form action="{{ url('informacion/' . $documento->id()) }}" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <br>
                            <img src="https://firebasestorage.googleapis.com/v0/b/futurguidear.appspot.com/o/{{$documento['foto_ppal']}}?generation=1586550760215511&alt=media" width="200">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <br>
                            <img src="https://firebasestorage.googleapis.com/v0/b/futurguidear.appspot.com/o/{{$documento['foto']}}?generation=1586550760215511&alt=media" width="200">
